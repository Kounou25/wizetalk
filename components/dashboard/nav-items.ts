...
/**
 * Sections principales du produit.
 *
...
/**
 * Section a laquelle appartient le chemin courant.
 *
 ...
 * correspondent.
 */
export function currentSection(pathname: string, items: NavItem[]): NavItem | undefined {
  return items
