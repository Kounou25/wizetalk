...
export const fr = {
  ...
  dashboard: {
    ...
    botPage: {
      ...
      activityTitle: 'Activité de cet assistant',
      activityLead: 'Les échanges avec les visiteurs de votre site.',
      loopTitle: 'Questions sans réponse et prospects',
      loopLead: 'Ce que votre site ne dit pas encore, et les contacts récupérés en face.',
      answerRate: 'Taux de réponse',
      answerRateHint: 'des messages ont trouvé une réponse',
      sourcesTitle: 'Sources de connaissances',
      sourceWebsite: 'Pages de votre site',
      sourceDocuments: 'Documents ajoutés',
      sourcesEmpty: 'Rien d’indexé pour l’instant.',
    },
    ...
    settings: {
      ...
      logoLabel: 'Logo',
      logoHint: 'PNG, JPG ou WebP · 1 Mo maximum',
      logoAdd: 'Ajouter un logo',
      logoReplace: 'Remplacer',
      logoRemove: 'Retirer',
      logoUploading: 'Envoi…',
      logoEmpty: 'Sans logo, l’assistant affiche l’initiale de son nom.',
      logoErrorFormat: 'Format non pris en charge. PNG, JPG ou WebP uniquement.',
      logoErrorTooLarge: 'Fichier trop volumineux (1 Mo maximum).',
      logoErrorFailed: 'L’envoi a échoué. Réessayez dans un instant.',
