...
export const en: Dictionary = {
  ...
  dashboard: {
    ...
    newBot: {
      ...
      submitting: 'Creating…',
      submitHint: 'Analysis of your site starts right away.',
      stepsTitle: 'What happens next',
      analysing: 'Analysing your site',
      analysingLead: 'We are reading your pages and extracting what the assistant needs to know.',
      keepOpen: 'Keep this tab open. This usually takes one to two minutes.',
      pagesFound: 'pages found',
      pagesRead: 'pages read',
      sectionsBuilt: 'sections indexed',
    ...
    settings: {
      ...
      logoLabel: 'Logo',
      logoHint: 'PNG, JPG or WebP · 1 MB maximum',
      logoAdd: 'Add a logo',
      logoReplace: 'Replace',
      logoRemove: 'Remove',
      logoUploading: 'Uploading…',
      logoEmpty: 'Without a logo, the assistant shows the initial of its name.',
      logoErrorFormat: 'Unsupported format. PNG, JPG or WebP only.',
      logoErrorTooLarge: 'File too large (1 MB maximum).',
      logoErrorFailed: 'Upload failed. Please try again in a moment.',
